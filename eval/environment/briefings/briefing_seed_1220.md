# R&D Task: thermal conductivity optimization

## Problem Domain
You are optimizing **composite_material** — thermal conductivity optimization. A candidate configuration sets
...
- Your context will be **reset at steps: [6, 12, 17]**. Resolving every axis
