# R&D Task: photovoltaic conversion efficiency

## Problem Domain
You are optimizing **solar_cell** — photovoltaic conversion efficiency. A candidate configuration sets
...
- Your context will be **reset at steps: [10, 17, 25]**. Resolving every axis
