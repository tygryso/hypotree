# R&D Task: radiation pattern optimization

## Problem Domain
You are optimizing **antenna_design** — radiation pattern optimization. A candidate configuration sets
...
- Your context will be **reset at steps: [10, 20, 29]**. Resolving every axis
