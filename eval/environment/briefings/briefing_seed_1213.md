# R&D Task: signal-to-noise ratio improvement

## Problem Domain
You are optimizing **sensor_calibration** — signal-to-noise ratio improvement. A candidate configuration sets
...
- Your context will be **reset at steps: [10, 19, 27]**. Resolving every axis
