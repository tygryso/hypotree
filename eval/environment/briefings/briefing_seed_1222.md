# R&D Task: throughput latency minimization

## Problem Domain
You are optimizing **algorithm_tuning** — throughput latency minimization. A candidate configuration sets
...
- Your context will be **reset at steps: [10, 18, 26]**. Resolving every axis
